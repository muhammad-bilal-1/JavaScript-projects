...
function Input_Digit(digit) {
    ...
    // Checks if the Wait_Second_Operand variable is true
    // and sets Display_Value to the key that was clicked on
    if (Wait_Second_Operand === true) {
        ...
        // Otherwise, it concatenates the value
...
function Handle_Operator(Next_Operator) {
    ...
    const Value_of_Input =
        parseFloat(Display_Value);


    // Checks if an operator exists and if
    // Wait_Second_Operand is true
...
// with the contents of Display_Value
